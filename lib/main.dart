...
import 'package:loja_alura/Pages/carrinho_compras.dart';
import 'package:loja_alura/modelos/item_carrinho.dart';
import 'package:loja_alura/paleta_cores.dart';
import 'package:loja_alura/widgets/appbar_customizada.dart';
import 'package:loja_alura/widgets/grid_produtos.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      routes: {'/carrinho': (context) => ShoppingCart()},
      title: 'Flutter Demo',
